...
**三、线段让这个近似变好，但不能消除它。**
线段由**至少三笔**构成——而"至少三段"正是分解定理二对走势类型的要求
（第 1 章 1.6 节）。所以线段在形式上比笔更像一个走势类型：
...
〔定义〕**线段**（据公开转述，第 62、65 课）：
由**至少三笔**构成，且满足特定破坏条件的更高一层方向段。

两个要点：

1. **至少三笔**——这是数量下界，对应分解定理二；
2. **破坏条件**——线段什么时候结束，由"它有没有被破坏"决定，
   而不是由"它够不够三笔"决定。

第 2 点是关键，也是第 10 章的全部内容。

〔定义〕**线段的破坏**（据公开转述，第 65 课）：
线段被破坏，**当且仅当被另一个线段破坏**。
...
| "三笔就构成一个线段" | ❌ 明确错误 | 三笔是**下界**不是完成条件。线段什么时候结束由破坏条件决定（第 10 章）。机械三笔一段会切断延伸，并直接违反"线段方向交替"这条〔推论〕 |
