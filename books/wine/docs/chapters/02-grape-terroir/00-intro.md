...
> **第二部分六章已全部完成。** 按大纲，本部分**不单独设实战项目**——
> 品种与风土的内容会在**第四部分的项目 P3（产区深度档案）**里被完整地用一次。
> 最新进度见[学习路线图](../../roadmap.md)。
...
- ✅ 第 10 章 [红葡萄品种谱系](10-red-varieties.md)
- ✅ 第 11 章 [葡萄园管理：产量、架式、有机与生物动力](11-vineyard-management.md)

完整大纲见[学习路线图](../../roadmap.md)。
接下来是[第三部分 · 酿造与陈年工艺](../03-winemaking/00-intro.md)。
